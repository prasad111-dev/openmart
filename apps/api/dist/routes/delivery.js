...
router.get('/assignments', authenticate, authorize('DELIVERY_BOY'), async (req, res) => {
...
router.get('/shop-assignments', authenticate, authorize('SHOP_OWNER'), async (req, res) => {
...
router.put('/:id/update-status', authenticate, authorize('DELIVERY_BOY'), async (req, res) => {
...
router.post('/:id/verify-otp', authenticate, authorize('DELIVERY_BOY'), async (req, res) => {
    const { otp } = req.body;
    const delivery = await prisma.delivery.findFirst({
        where: { id: req.params.id, deliveryBoyId: req.user?.userId },
    });
...
router.put('/location/update', authenticate, authorize('DELIVERY_BOY'), async (req, res) => {
...
router.get('/:deliveryId/location', authenticate, async (req, res) => {
...
router.get('/order/:orderId/location', authenticate, async (req, res) => {
    const delivery = await prisma.delivery.findFirst({
