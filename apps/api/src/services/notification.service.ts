...
export async function sendShopApproval(userId: string, shopName: string, approved: boolean) {
  return sendNotification({
    userId,
...
export async function sendDeliveryAssignment(deliveryBoyId: string, orderId: string) {
  return sendNotification({
...
export async function sendOTP(userId: string, otp: string) {
  return sendNotification({
    userId,
